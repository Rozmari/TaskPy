...
def RememberAnna():
    ...
    os.remove(output)
    echo "Anna begins to change her mind. // List sent to the Boatman."
    return

def ForgetItAll():
    os.remove(output)
    echo "All your love was just a dream. // Just like that, it's over."
    return
...
## parser.add_argument('-c', '--clear', action='store_const',default=act1,const=act2)
## parser.add_argument('-cs', '--clearsave', action='store_const',default=act1,const=act2);
## parser.add_argument('-s', '--see', action='store_const',default=act1,const=act2);
